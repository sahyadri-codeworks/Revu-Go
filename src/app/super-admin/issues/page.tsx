    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-[13px] text-[#6B7280] mt-1">
          Manage and respond to support tickets from business owners
        </p>
      </div>
        ...
        <div className="flex gap-1.5">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-[11px] font-medium transition-all ${
              filterStatus === "all" ? "bg-[#166534]/10 text-[#166534]" : "text-[#6B7280] hover:bg-[#F3F4F6]"
            }`}
          >
            All
          </button>
          {ALL_STATUSES.map((s) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-[11px] font-medium transition-all ${
                filterStatus === s ? "text-white" : "hover:bg-[#F3F4F6]"
              }`}
              style={filterStatus === s
                ? { backgroundColor: STATUS_CONFIG[s].color, color: "#fff" }
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {filtered.map((ticket, i) => {
            ...
            const unreadFromBiz = ticket.messages.filter(
                              ...
                              <div key={msg.id} className={`flex ${msg.sender_type === "admin" ? "justify-end" : "justify-start"}`}>
                                <div className={`max-w-[75%] rounded-2xl px-4 py-3 ${
                                  msg.is_internal_note
                                    ...
                                    ? "bg-[#166534]/8 border border-[#166534]/10"
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center gap-3 mb-1">
                              <button
                                ...
                                className={`text-[11px] font-medium px-3 py-1 rounded-lg transition-all ${
                                  !isInternalNote ? "bg-[#166534]/10 text-[#166534]" : "text-[#6B7280] hover:bg-[#F3F4F6]"
                                }`}
                              >
                                Reply to Client
                              </button>
                              <button
                                ...
                                className={`text-[11px] font-medium px-3 py-1 rounded-lg transition-all flex items-center gap-1.5 ${
                                  isInternalNote ? "bg-[#FEF9C3] text-[#CA8A04] border border-[#FDE68A]" : "text-[#6B7280] hover:bg-[#F3F4F6]"
                                }`}
                              >
                            ...
                            <div className="flex gap-2">
                              <textarea
                                ...
                                rows={2}
                                className={`flex-1 px-4 py-2.5 rounded-xl border text-[13px] text-[#111] placeholder:text-[#9CA3AF] focus:outline-none transition-all resize-none ${
                                  isInternalNote
                                    ? "bg-[#FFFBEB] border-[#FDE68A] focus:border-[#F59E0B]/50"
                                    : "bg-[#F9FAFB] border-[#E5E7EB] focus:border-[#166534]/30"
                                }`}
                              />
                              <button
                                onClick={() => handleReply(ticket.id)}
                                disabled={!replyText.trim() || sending}
                                className={`px-4 self-end py-2.5 rounded-xl text-white transition-all disabled:opacity-30 ${
                                  isInternalNote ? "bg-[#CA8A04] hover:bg-[#A16207]" : "bg-[#166534] hover:bg-[#15803D]"
                                }`}
                              >
